    ...
    if (mode === "comparison") {
      ...
      try {
        ...
        if (dataA.actual_date && dataA.actual_date !== dateA) {
          warnings.push(`Data A solicitada: ${dateA}. Dados disponíveis para: ${dataA.actual_date}.`);
        }
        if (dataB.actual_date && dataB.actual_date !== dateB) {
          warnings.push(`Data B solicitada: ${dateB}. Dados disponíveis para: ${dataB.actual_date}.`);
        }
