...
export default function HeroSection() {
  return (
    <header className="relative w-full min-h-[80vh] md:min-h-[819px] flex flex-col items-center justify-center px-4 sm:px-6 cyber-river overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-6">
        ...
        <h1 className="font-headline text-4xl sm:text-6xl md:text-8xl font-extrabold tracking-tight leading-[0.9] text-primary break-words">
