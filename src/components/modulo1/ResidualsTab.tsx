  ...
  return (
    <div className="space-y-4">
        ...
        <Plot
          data={[
            ...
            },
            {
              ...
              type: "scatter",
              mode: "lines",
              line: { color: "#707975", dash: "dash", width: 1 },
              showlegend: false,
          ...
          layout={{
            ...
            plot_bgcolor: "#ffffff",
            font: { color: "#191c1d", family: "Inter, Manrope, sans-serif" },
            xaxis: {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <div key={s.label} className="glass-panel rounded-lg p-3 text-center">
            <div className="text-outline text-xs uppercase tracking-wider mb-1">
              {s.label}
            </div>
            <div className="text-on-surface text-lg font-mono">
              {s.value} <span className="text-xs text-outline">p.p.</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <details className="glass-panel rounded-lg">
        ...
        <div className="px-4 pb-4 text-outline text-sm leading-relaxed space-y-2">
          <p>
