export default function MethodologyCards() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      {/* Methodology Block */}
      <div className="p-8 glass-panel rounded-3xl border border-outline-variant/15">
        ...
        <div className="space-y-4 text-on-surface-variant text-sm leading-relaxed">
          ...
          <div className="p-4 bg-surface-container-lowest rounded-xl font-mono text-primary-container text-xs">
      ...
      <div className="p-8 bg-surface-container rounded-3xl border border-outline-variant/10 flex flex-col justify-between">
        <div className="flex justify-between items-start">
          ...
          <span className="px-2 py-1 rounded bg-secondary/10 text-secondary text-[10px] font-bold">
            CONECTADO
          </span>
        </div>
        <div className="mt-8">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-secondary text-xs font-bold">+0.02%</span>
          </div>
      ...
      <div className="p-8 bg-surface-container-high rounded-3xl border border-outline-variant/10">
