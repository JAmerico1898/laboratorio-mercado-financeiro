      ...
      <Plot
        data={[
          // Top chart — Data A observed
          {
            ...
            marker: { color: "#00314a", size: 6, opacity: 0.5 },
            yaxis: "y",
          },
          ...
          // Top chart — Data B observed
          {
            ...
            marker: { color: "#dc2626", size: 6, opacity: 0.5 },
            yaxis: "y",
          },
          ...
          // Bottom chart — zero reference line
          {
            ...
            mode: "lines" as const,
            type: "scatter" as const,
            line: { color: "#707975", width: 1, dash: "dash" as const },
            showlegend: false,
            yaxis: "y2",
          },
        ]}
          ...
          annotations: [
            {
              ...
              y: 1.22,
              showarrow: false,
              font: { size: 16, color: "#191c1d", family: "Manrope, sans-serif" },
              xanchor: "center" as const,
            },
          ],
          xaxis: {
