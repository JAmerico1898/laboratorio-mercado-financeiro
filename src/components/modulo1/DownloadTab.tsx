  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <button
        ...
        className="glass-panel rounded-xl p-6 text-left hover:bg-surface-container-high/50 transition-colors group"
      >
        <div className="text-on-surface text-base font-semibold mb-2 group-hover:text-primary-container transition-colors">
        ...
        <div className="mt-3 text-xs text-outline font-mono">
