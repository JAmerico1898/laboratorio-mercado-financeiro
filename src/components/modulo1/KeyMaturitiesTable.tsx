import { KEY_MATURITIES } from "@/lib/constants";
...
export default function KeyMaturitiesTable({
  ...
  return (
    <div className="glass-panel rounded-xl overflow-hidden">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-outline-variant/30">
              <th className="text-left px-4 py-3 text-outline uppercase text-xs font-semibold tracking-wider">
                Prazo
              </th>
              <th className="text-right px-4 py-3 text-outline uppercase text-xs font-semibold tracking-wider">
                DU
              </th>
              <th className="text-right px-4 py-3 text-outline uppercase text-xs font-semibold tracking-wider">
                Taxa A (%)
          ...
          <tbody>
            {maturities.map((du) => {
              ...
              return (
                <tr
                  key={du}
                  className="border-b border-outline-variant/10 even:bg-surface-container-high/30"
                >
      ...
      <div className="px-4 py-2 text-outline text-xs border-t border-outline-variant/20">
