...
import type { Scenario } from "@/data/gestao-credito-cenarios/types";
import { DIFFICULTY_LABEL } from "@/data/gestao-credito-cenarios/types";
import { useRegScenario } from "./useRegScenario";
...
export default function ScenarioPlayer({ scenario }: { scenario: Scenario }) {
  ...
  const p = useRegScenario(scenario);
  ...
  return (
    <div data-theme="light" className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <div className="sticky top-0 z-30 border-b border-outline-variant bg-surface/90 backdrop-blur-md">
        <div className="mx-auto max-w-4xl px-6 py-3">
          ...
          <p className="mt-2 text-[11px] font-semibold uppercase tracking-wider text-on-surface-variant">
            {scenario.code} · {scenario.protagonist} · {DIFFICULTY_LABEL[scenario.difficulty]}
          </p>
          <div className="mt-2">
      ...
      <main className="mx-auto max-w-4xl space-y-6 px-6 py-8">
        ...
        <CollapsibleStatements details={scenario.details} label={scenario.detailBoxLabel} />
