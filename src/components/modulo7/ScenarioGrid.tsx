...
import type { Difficulty, Scenario } from "@/data/fidc-v2/types";
import { DIFFICULTY_LABEL } from "@/data/fidc-v2/types";
import { readCompletion, type CompletionRecord } from "./useFidcScenario";
          ...
          <div className="mt-6 grid grid-cols-1 items-center gap-10 lg:grid-cols-5">
            <div className="lg:col-span-2">
              ...
              <p className="mt-6 max-w-xl border-l-2 border-primary/30 pl-4 text-lg font-light leading-relaxed text-on-surface-variant">
                Cinco casos aplicados de Fundos de Investimento em Direitos Creditórios: ciclo de caixa,
                subordinação, concentração de risco (cedente × sacado) e descasamento de indexador.
              </p>
            </div>
              ...
              >
                <div>
                  ...
                  <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-on-surface-variant">
                    {s.code} · ~{s.estMinutes} min · {s.archetype}
                  </p>
