...
export default function TokenKinetic() {
  return (
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="w-full h-full glass-panel rounded-3xl overflow-hidden p-8 flex flex-col justify-between border border-outline-variant/15">
          ...
          <div className="flex items-center justify-between px-4">
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="w-14 h-14 rounded-xl bg-[#1a2a3a] flex items-center justify-center text-2xl shadow-[0_0_15px_rgba(0,242,255,0.2)]">
                📜
              </div>
              <span className="text-[9px] text-outline-variant font-bold uppercase tracking-wide">
                Smart Contract
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="flex gap-1">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-[#1f3a2a] flex items-center justify-center text-base shadow-[0_0_10px_rgba(78,222,163,0.15)]"
                    style={{ marginTop: i === 1 ? "-6px" : "0" }}
                  >
                    🪙
                  </div>
                ))}
          ...
          <div className="flex items-end gap-1 h-32 mt-4">
            {[
              { h: "85%", color: "from-primary-container/40 to-primary-container" },
              { h: "60%", color: "from-primary-container/30 to-primary-container/80" },
              { h: "40%", color: "from-secondary/40 to-secondary" },
              { h: "75%", color: "from-secondary/30 to-secondary/80" },
              { h: "50%", color: "from-primary-container/40 to-primary-container" },
              { h: "30%", color: "from-secondary/40 to-secondary" },
              { h: "90%", color: "from-primary-container/30 to-primary-container/90" },
              { h: "65%", color: "from-secondary/30 to-secondary/80" },
              { h: "45%", color: "from-primary-container/40 to-primary-container" },
            ].map((bar, i) => (
              <div
                key={i}
